...
all_train, all_test, train_state_labels, test_state_labels, ts, all_ofc = neur.make_cue_psuedo_pop(datadir, 200)
...
all_train, all_test, train_val_labels, test_val_labels, ts, all_ofc = neur.make_choice_value_psuedo_pop(datadir, 200)
