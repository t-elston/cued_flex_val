function [newX newY newXYts yg fg to mean_thetaCOH mean_thetaCh1 mean_thetaCh2] = lap_SpecMap3D(ch1,ch2,downsampling,nFFT,fs,wlength,overlap,tapers,detrend,keep,thetaband,sPX,sPY,sts);
...
for i=1:length(nPositionY_ts);
 ...
 dist=(to-nPositionY_ts(i)).^2;
    ...
    lin_mapCoh(:,i)=coh(:,ind(1));
    lin_mapCh1(:,i)=ch1PSD(:,ind(1));
    lin_mapCh2(:,i)=ch2PSD(:,ind(1));
...
%purposes
%  [XI,YI]=meshgrid(10:10:800,30:10:700);
