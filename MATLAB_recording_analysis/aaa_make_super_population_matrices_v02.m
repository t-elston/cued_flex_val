...
for f = 1:numel(rec_files)
    ...
    bhv2 = array2table(bhv,'VariableNames',bhv_varnames);
    ...
    for u = 1:n_units
        ...
        if OFC_ix(u) == 1
            ...
            OFC_data.u_names = [OFC_data.u_names ; repmat(unit_names(u),n_trials,1)]; 
            OFC_data.bhv = [OFC_data.bhv ; bhv];
            ...
            HPC_data.u_names = [HPC_data.u_names ; repmat(unit_names(u),n_trials,1)]; 
            HPC_data.bhv = [HPC_data.bhv ; bhv];
